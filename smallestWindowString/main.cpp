...
int main() {
    ...
    std::cout << "t stri == "<< findSmallestWindows(cont, chars)  << std::endl;
    std::cout << "aksfaje == "<< findSmallestWindows("ahffaksfajeeubsne", "jefaa")  << std::endl;
    std::cout << "affhkkse == "<< findSmallestWindows("aaffhkksemckelloe", "fhea")  << std::endl;
    return 0;
}
